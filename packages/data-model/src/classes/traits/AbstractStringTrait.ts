...
/** Abstract class with behaviour for traits that have string values */
export default abstract class AbstractStringTrait<T extends iTraitData> extends BaseTrait<T> implements iBaseTrait {
