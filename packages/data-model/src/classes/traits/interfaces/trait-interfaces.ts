...
export interface iAbstractBaseTraitProps<
  N extends TraitNameUnionOrString,
  V extends TraitValueTypeUnion,
  D extends iBaseTraitData<N, V>
...
export interface iBaseNumberTraitProps<
  N extends TraitNameUnionOrString,
...
/** Props for the abstract number class */
export interface iAbstractNumberTraitProps<
  N extends TraitNameUnionOrString,
  D extends iNumberTraitData<N>
> extends iBaseNumberTraitProps<N, D>,
    iHasGetData<D> {}

/** Props for a general number trait */
export interface iNumberTraitProps<N extends TraitNameUnionOrString>
  extends iBaseNumberTraitProps<N, iNumberTraitData<N>> {}

/** Props for a number trait with a category */
export interface iNumberTraitWithCategoryProps<
  N extends TraitNameUnionOrString,
  C extends string
> extends iBaseNumberTraitProps<N, iNumberTraitData<N>> {
  categorySelector: (name: N) => C;
...
export interface iNumberTrait<N extends TraitNameUnionOrString>
  extends iBaseNumberTrait<N, iNumberTraitData<N>> {}

export interface iBaseStringTrait<
  N extends TraitNameUnionOrString = string,
  V extends string = string
> extends iBaseTrait<N, V, iBaseTraitData<N, V>> {}

export interface iStringTrait<
  N extends TraitNameUnionOrString = string,
  V extends string = string
> extends iBaseStringTrait<N, V> {}

export interface iNumberTraitWithCategory<
  N extends TraitNameUnionOrString = string,
