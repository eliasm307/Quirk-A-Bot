import {
  iBaseTraitDataStorage, iBaseTraitDataStorageProps, iTraitCollectionDataStorage
} from '../../declarations/interfaces/data-storage-interfaces';
import {
  iAddLogEventProps, iDeleteLogEventProps, iTraitCollectionLogger, iTraitCollectionLogReporter
...
import {
  iBaseTrait, iBaseTraitData, iTraitCollectionProps
...
> implements iTraitCollection<N, V, D, T> {
  ...
  constructor(
		...
		this.logger = logger || new TraitCollectionLogger({ sourceName: name, parentLogHandler: null });
